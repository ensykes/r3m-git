...
state_ghgrp_reporting_facility_list_by_gas_type <- function(state_of_choice){
  ghgrp_2019_emissions_type_long %>% 
  separate_rows(industry_type_sectors, sep = ",")%>% 
...
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "TX")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "UT")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "ME")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "SC")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "IN")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "IL")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "FL")
state_ghgrp_reporting_facility_list_by_gas_type(state_of_choice = "CA")
